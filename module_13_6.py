...
button4 = InlineKeyboardButton(text='Формула', callback_data='формула')
button5 = InlineKeyboardButton(text='Расчет', callback_data='Мои калории')
ikb.add(button4, button5)
